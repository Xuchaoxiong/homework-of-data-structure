...
extern byte	** pixelRecognize(byte **image, uint32_t width, uint32_t heigth,
...
{	
	...
	pixelRecognize(BI,bmpInfoHeader.biWidth,bmpInfoHeader.biHeight,1560,1);
	printf("请输入要保存的二值图路径：\n");
	gets(writeFileName);
